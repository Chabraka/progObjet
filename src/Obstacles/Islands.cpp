...
float floor_low_medium, float floor_medium_high, const p6::Shader* shader, LightProperties lightprop):Islands(islandNb, border,
floor_low_medium, floor_medium_high, shader){
	light = lightprop;
}
...
void Islands::drawIsland(Island *island, glm::mat4 ProjMatrix, glm::mat4 ViewMatrix, float cam_distance, Light sun, Light walker)
{
