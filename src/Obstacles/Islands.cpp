...
/* ----- Constructor ----- */
Islands::Islands(const uint islandNb, const float border, float floor_low_medium, float floor_medium_high, const p6::Shader* shader)
{
    this->renderer = MultiResObjRenderer("assets/models/floating_island_low.obj", "assets/models/floating_island_medium.obj", "assets/models/floating_island.obj", "assets/textures/floating_island.png", shader, floor_low_medium, floor_medium_high);
