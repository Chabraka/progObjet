...
/* ----- Draw ----- */
void Skybox::drawSkybox(const p6::Shader* shader, glm::mat4 ProjMatrix, glm::mat4 ViewMatrix, GLuint vao)
{
    ...
    shader->set("uColor", glm::vec3(0.1, 0.1, 0.9));

    drawOpenGLSkybox(vao);
}